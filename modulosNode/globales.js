//console.log, console.error, timeouts
//Que son dependencias circulares
console.log(global) 
/*Object [global] {
...
let intervalo = setInterval(() => {  // Asigno el setInterval a una variable intervalo para poder operarla luego.
    console.log(" Didier "); // Imprimo mi nombre
...
//__dirname: muestra el nombre del directorio 
//__filename: Muestra el nombre del archivo